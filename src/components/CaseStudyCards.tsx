...
export function CaseStudyCards() {
  return (
    <section className="max-w-[1200px] mx-auto px-10 py-16 relative">
      <div
      ...
      <h2 className="font-heading text-[clamp(4rem,7vw,8rem)] font-black uppercase tracking-tighter leading-[0.85] mb-12 text-obsidian relative z-10">
        How I Think.
      </h2>

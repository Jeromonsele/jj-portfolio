...
export function ProductStrip() {
  return (
    <section className="max-w-[1200px] mx-auto px-10 pt-20 pb-16 relative">
      <div
      ...
      <h2 className="font-heading text-[clamp(4rem,6vw,7rem)] font-black uppercase tracking-tighter leading-[0.85] mb-12 text-obsidian relative z-10">
        Products.
      </h2>

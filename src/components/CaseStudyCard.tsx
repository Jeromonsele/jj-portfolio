...
export function CaseStudyCard({ caseStudy }: { caseStudy: CaseStudy }) {
  return (
    <a
      ...
      className="block border border-obsidian/10 p-6 md:p-10 hover:border-obsidian transition-all duration-300 active:scale-[0.98] group bg-cream relative z-10"
    >
      <div className="flex flex-col">
        {/* Top Header: Tags + Metric Badge */}
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 sm:justify-between sm:items-start mb-6 w-full">
          <p className="font-mono text-[10px] text-tvgg-rust font-semibold uppercase tracking-widest mt-1">
            {caseStudy.tags.join(" · ")}
          </p>
          <div className="bg-obsidian/[0.02] border border-obsidian/10 px-3 py-1.5 font-mono text-[10px] text-obsidian uppercase tracking-widest font-bold w-fit">
        ...
        <div className="flex-1 w-full max-w-4xl">
          <h3 className="text-xl md:text-2xl font-heading font-extrabold uppercase tracking-tighter mb-6 leading-none md:leading-tight">{caseStudy.title}</h3>

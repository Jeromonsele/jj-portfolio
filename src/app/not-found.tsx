    ...
    <>
      ...
      <main className="max-w-[1200px] mx-auto px-10 pt-32 pb-20 min-h-[70vh] flex flex-col items-center justify-center text-center">
        <div className="w-32 h-32 relative mb-8 opacity-50">
          <Image src="/avatar.png" alt="JJ Eromonsele" fill className="object-cover rounded-none" />
        </div>
        ...
        <a href="/" className="bg-obsidian text-cream px-8 py-3.5 text-xs font-semibold uppercase tracking-[1.5px] hover:bg-obsidian/85 transition-colors">
          Go Home →
        </a>
      </main>
    </>
